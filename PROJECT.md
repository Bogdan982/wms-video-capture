...
│     🎥 Видео записано                                   │
│     "Использовать ABC-123 или заменить через сканер?"   │
│     [✅ Использовать ABC-123]  [📷 Сканировать QR]      │
└─────────────────────────────────────────────────────────┘
         │                          │
         ▼                          ▼
┌──────────────────┐   ┌──────────────────────────────┐
│  5a. UploadScreen │   │  5b. ScanScreen + QRScanner  │
│  Выгрузка... 67%  │   │  📷 Наведите на QR-код      │
│  [████████░░░]    │   │  → получен новый ID: XYZ-789 │
└──────────────────┘   └──────────────┬───────────────┘
         │                            │
         └────────────┬───────────────┘
                      ▼
...
|-------|--------|----------|--------|
| `id_change` | 🎥 | «Видео записано. Выберите ID» | [Текущий ID] [QR] |
